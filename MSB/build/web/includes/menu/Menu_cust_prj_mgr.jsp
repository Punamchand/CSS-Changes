                ...
                <div id="sportswear" class="panel-collapse collapse">
                    <div class="panel-body" >
                        <ul>
                            ...
                            %>
                            <li><a href="/<%=ApplicationConstants.CONTEXT_PATH%>/getMainProjects.action">Projects Search</a></li>
                            <li><a href="/<%=ApplicationConstants.CONTEXT_PATH%>/budgets/ProjectBudgetDetails.action">Budgets</a></li>
                            <li><a href="/<%=ApplicationConstants.CONTEXT_PATH%>/recruitment/consultant/getLoginUserRequirementList.action?orgid=<%=orgId%>&customerFlag=customer&accountFlag=MyRequirements">Requirements&nbsp;List</a></li>
