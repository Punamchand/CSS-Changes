...
<html>
    <head>
        ...
        <title>Miracle Service Bay ::  Account Contact Edit Page</title>
                                            ...
                                            <div>
                                                ...
                                                <div class="inner-reqdiv-elements">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-3">
                                                            <label class="contactLabelStyle"><span style="color:red;">*</span>First Name:</label><s:textfield  name="ContactFname" value="%{accountContactVTO.firstName}"  id="ContactFname" required="true" cssClass="form-control" placeholder="first Name" onkeyup="contactFirstNameValidation()"/>
                                                        </div>
                                                        <div class="col-lg-3">
                                                            <label class="contactLabelStyle">Middle&nbsp;Name:</label><s:textfield name="ContactMname" value="%{accountContactVTO.middleName}" id="ContactMname"  cssClass="form-control" placeholder="middle Name"  onfocus="removeResultMessage()" pattern='[A-Za-z\\s]*' />   
                                                        </div>
                                                        <div class="col-lg-3">
                                                            <label class="contactLabelStyle"><span style="color:red;">*</span>Last Name:</label><s:textfield name="ContactLname" value="%{accountContactVTO.lastName}" id="ContactLname"  cssClass="form-control" placeholder="last Name"  onkeyup="contactLastNameValidation()"/>
                                                        </div>
                                                        <div class="col-lg-3">
                                                        ...
                                                        <div class="col-lg-3">
                                                            <label class="contactLabelStyle">Alternate&nbsp;Email:</label><s:textfield cssClass="form-control" value="%{accountContactVTO.email2}" name="ContactEmail2" id="ContactEmail2" pattern="[^@]+@[^@]+\.[a-zA-Z]{2,}" oninvalid="setCustomValidity('Must be valid email')" onchange="try{setCustomValidity('')}catch(e){}" onkeyup="removeActionMessage()"/>
                                                        </div>
                                                        <div class="col-lg-3">
                                                ...
                                                <div class="inner-reqdiv-elements">
                                                    <div class="row"> 
                                                        ...
                                                        <div class="col-lg-4">
                                                            <label class="contactLabelStyle">Address</label><s:textfield cssClass="form-control"  value="%{accountContactVTO.conPAddress}"  id="conAddress" name="conAddress"      /> <!-- onkeyup="paddresValidation()" -->
                                                        </div>
                                                        <div class="col-lg-4">
                                                            <%--label class="contactLabelStyle">Designation:</label><s:select cssClass="SelectBoxStyles form-control" name="contactDesignation" id="designation" headerKey="0" value="%{accountContactVTO.contactDesignation}" headerValue="-Select-" list="%{accountContactVTO.titles}"/--%>
                                                            <label class="contactLabelStyle">Address2</label><s:textfield cssClass="form-control"  value="%{accountContactVTO.conPAddress2}" id="conAddress2" name="conAddress2"/>
                                                        </div>

                                                        <div class="col-lg-4">
                                                            <label class="contactLabelStyle">City</label><s:textfield cssClass="form-control"  value="%{accountContactVTO.conPCity}"  id="conCity" name="conCity" pattern="[a-zA-Z\s]{3,}" title="must be valid name" />
                                                        </div>
                                                        <div class="col-lg-4">
                                                        ...
                                                        <div class="col-lg-4">
                                                            <label class="contactLabelStyle">Zip</label><s:textfield cssClass="form-control"  value="%{accountContactVTO.conPZip}"  id="conZip" name="conZip" maxLength="10"    /> <!-- onkeyup="contactPZipValidation()" -->
                                                        </div>
