...
<html>
    <head>
        ...
        <title>Miracle Service Bay :: Action Resources Page</title>
    ...
    <body style="overflow-x: hidden" onload="getAccountNames();">
                        ...
                        <div class="features_items">
                            <div class="col-lg-16 ">
                                <div class="" id="profileBox" style="float: left; margin-top: 5px">
                                    ...
                                    <!-- content start -->
                                    <div ><label class="labelStylereq" style="color:#56a5ec;">Action Name:&nbsp; </label><label style="color: green"><s:property value="action_name" /></label></div>
                                    ...
                                    <div class="col-sm-16">
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <s:textfield id="accountNamePopup"
                                                         ...
                                                         type="text"
                                                         name="accName" value="%{accountName}"
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <s:textarea id="addingAccAuthDesc" cssClass="form-control" name="addingAccAuthDesc" value="%{description}"/>
                                        </div>
                                        <div class="col-lg-4">
                                        ...
                                        <div class="col-lg-4">
                                            <s:if test="flag=='update'">
                                                ...
                                                <input type="button"
                                                       class="cssbutton"
                                                       value="Update" onclick="return insertOrUpdateActionResources('1');"/>
                                            </s:if>
                                            <s:else>
                                                <label class="labelStylereq" style="color:#56a5ec;"></label>
                                                ...
                                                <input type="button"
                                                       class="cssbutton"
                                                       value="Add" onclick="return insertOrUpdateActionResources('0');"/>
                                            </s:else>
                                        </div>
