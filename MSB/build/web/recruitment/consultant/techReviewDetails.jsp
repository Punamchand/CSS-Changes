                                            ...
                                            <div class="inner-reqdiv-elements">
                                                <div class="row">
                                                    <div class="col-lg-3">
                                                        ...
                                                        <s:textfield cssClass="form-control dateImage" name="reviewStartDate" id="reviewStartDate" placeholder="From Date"  tabindex="1"  onkeypress="return enterDateRepository();"/>
                                                    </div>
                                                    <div class="col-lg-3">
                                                        <label class="labelStylereq" style="color: #56a5ec;">To: </label>
                                                        <s:textfield cssClass="form-control dateImage" name="reviewEndDate" id="reviewEndDate" placeholder="To Date"  tabindex="1"  onkeypress="return enterDateRepository();"/>
                                                    </div>
                                                    <div class="col-lg-3">
                                                        <label class="labelStylereq" style="color: #56a5ec;">Status: </label>
                                                        <s:select cssClass="SelectBoxStyles form-control" name="techReviewStatus" id="techReviewStatus" headerKey="-1" headerValue="All" list="#@java.util.LinkedHashMap@{'Processing':'Processing','ShortListed':'ShortListed','Rejected':'Rejected'}" />
                                                    </div>
                                                    <div class="col-lg-2">
                                                    ...
                                                    <table id="techReviewTable" class="responsive CSSTable_task" border="5"cell-spacing="2">
                                                        <tbody>
                                                            ...
                                                            <s:iterator  value="consultantList">
                                                                ...
                                                                <s:url id="myUrl" action="editConsultantDetails.action?consultFlag=customer&techReviewFlag=techReview">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <s:if test="status=='Rejected'">
                                                                        <td><figcaption><button type=button value="<s:property value="resumeId"></s:property>" ><img src='../../includes/images/download.png' height='20' width='20' style="opacity: 0.3"></button></figcaption></td>
                                                                <td><s:a href="#" cssClass=""  style="opacity: 0.5">Click</s:a></td>
