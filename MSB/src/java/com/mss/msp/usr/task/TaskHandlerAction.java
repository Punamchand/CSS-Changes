    ...
    public String tasksSearch() {
        ...
        try {
            ...
            if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString() != null) {
                ...
                teamtaskDetails = ServiceLocator.getTaskHandlerService().getLoggedInEmpTasksDetails(httpServletRequest, this);
    ...
    public String showTaskSearchDetails() {
        ...
        try {
            if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString() != null) {
                ...
                setTasksStatusList(dataSourceDataProvider.getInstance().getTaskStatusByOrgId());
                setTasksRelatedToList(dataSourceDataProvider.getInstance().getTaskrelatedToMap());
                teamtaskDetails = ServiceLocator.getTaskHandlerService().getEmployeeTasksDetails(this, httpServletRequest);
                System.out.println(teamtaskDetails.size());
    ...
    public String getTaskDetails() {
        ...
        try {
            if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
                ...
                tasksVto = (ServiceLocator.getTaskHandlerService().getEditTaskDetails(this, httpServletRequest));
                taskAttachments = (dataSourceDataProvider.getInstance().getAttachmentDetails(httpServletRequest, this));
                resultType = SUCCESS;
            }
        } catch (Exception ex) {
            httpServletRequest.getSession(false).setAttribute("errorMessage:", ex.toString());
    ...
    public String addNewTaskDetails() {
        ...
        try {
            if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString() != null) {
                ...
                addresult = ServiceLocator.getTaskHandlerService().addTaskDetals(this, httpServletRequest);
    ...
    public String getTeamTaskDetails() {
        ...
        try {
            ...
            if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString() != null) {
                ...
                setTasksStatusList(dataSourceDataProvider.getInstance().getTaskStatusByOrgId());
                setTasksRelatedToList(dataSourceDataProvider.getInstance().getTaskrelatedToMap());
                teamtaskDetails = ServiceLocator.getTaskHandlerService().getLoggedInTeamTasksDetails(httpServletRequest, this);
    ...
    public String showTeamTaskSearchDetails() {
        ...
        try {
            if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString() != null) {
                ...
                teamtaskDetails = ServiceLocator.getTaskHandlerService().getTeamTasksDetails(this, httpServletRequest);
...
//                FileUtils.copyFile(taskAttachment, destFile);
                ...
                addresult = ServiceLocator.getTaskHandlerService().addAttachmentDetails(this, httpServletRequest);
                System.out.println("result adding taskkkkkkkkkkkkkkkkkkkkkk:::: " + addresult);
    ...
    public String updateTaskDetails() {
        ...
        try {
            if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
                ...
                int i = ServiceLocator.getTaskHandlerService().updateTaskDetails(this, httpServletRequest);
                if (getTaskStatus() == 3) {
    ...
    public String getNotesDetails() {
        ...
        try {
            if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
                System.out.println(this.getTaskid());
                String resultMsg = ServiceLocator.getTaskHandlerService().getNotesDetails(this, httpServletRequest);
    ...
    public String getNotesDetailsOverlay() {
        ...
        try {
            if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
                System.out.println(this.getTaskid());
                String resultMsg = ServiceLocator.getTaskHandlerService().getNotesDetailsOverlay(this, httpServletRequest);
                System.out.println(resultMsg);
                httpServletResponse.setContentType("text");
                httpServletResponse.setCharacterEncoding("UTF-8");
                httpServletResponse.getWriter().write(resultMsg);
    ...
    public String UpdateNotesDetails() {
        ...
        try {
            if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
                System.out.println(this.getTaskid());
                setUserSessionId(Integer.parseInt(httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString()));
                int resultMsg = ServiceLocator.getTaskHandlerService().UpdateNotesDetails(this, httpServletRequest);
    ...
    public String DoInsertNotesDetails() {
        ...
        try {
            if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
                ...
                setUserSessionId(Integer.parseInt(httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString()));
                int resultMsg = ServiceLocator.getTaskHandlerService().DoInsertNotesDetails(this, httpServletRequest);
...
//        }
    ...
    public String getNotesDetailsBySearch() {
        ...
        try {
            if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
                String resultMsg = ServiceLocator.getTaskHandlerService().getNotesDetailsBySearch(this, httpServletRequest);
...
/**
    ...
    public String getCommentsOnOverlay() {
        ...
        try {
            if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
                System.out.println(this.getTaskid());
                String resultMsg = ServiceLocator.getTaskHandlerService().getCommentsOnOverlay(this, httpServletRequest);
                System.out.println(resultMsg);
                httpServletResponse.setContentType("text");
                httpServletResponse.setCharacterEncoding("UTF-8");
                httpServletResponse.getWriter().write(resultMsg);
