...
public class RequirementAction extends ActionSupport implements ServletRequestAware, ServletResponseAware {
    ...
    public String doCopyRequirement() {
        ...
        try {
            ...
            if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
                ...
                setAccountName(dataSourceDataProvider.getInstance().getAccountNameById(getAccountSearchID()));
                setReqCategory(dataSourceDataProvider.getInstance().getRequiteCategory(1));
                requirementVTO = ServiceLocator.getRequirementService().editrequirement(getRequirementId());
                resultMessage = SUCCESS;
            }
        } catch (Exception ex) {
            httpServletRequest.getSession(false).setAttribute("errorMessage:", ex.toString());
    ...
    public String updateRequirements() {
        ...
        if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
            try {
                ...
                updated = ServiceLocator.getRequirementService().updateRequirement(httpServletRequest, userid, this);
    ...
    public String getRequirementDetails() {
        ...
        try {
            if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString() != null) {
                ...
                setUserSessionId(Integer.parseInt(httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString()));
                requirementskDetails = ServiceLocator.getRequirementService().getRequirementDetails(httpServletRequest, this);
                httpServletResponse.setContentType("text");
                httpServletResponse.setCharacterEncoding("UTF-8");
    ...
    public String getReqDetailsBySearch() {
        ...
        if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
            try {
                ...
                setUserSessionId(Integer.parseInt(httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString()));
                String list = ServiceLocator.getRequirementService().getReqDetailsBySearch(httpServletRequest, this);
                httpServletResponse.setContentType("text");
                httpServletResponse.setCharacterEncoding("UTF-8");
    ...
    public String getSkillDetaisls() {
        ...
        if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
            try {
                setUserSessionId(Integer.parseInt(httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString()));
                String skills = ServiceLocator.getRequirementService().getSkillDetaisls(httpServletRequest, this);
...
//                httpServletResponse.getWriter().write(proof);
    ...
    public String getRecruiterOverlay() {
        ...
        if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
            try {
                String list = ServiceLocator.getRequirementService().getRecruiterOverlay(httpServletRequest, this);
                httpServletResponse.setContentType("text");
                httpServletResponse.setCharacterEncoding("UTF-8");
                httpServletResponse.getWriter().write(list);
                resultMessage = null;
    ...
    public String getSkillOverlay() {
        ...
        if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
            try {
                String list = ServiceLocator.getRequirementService().getSkillOverlay(httpServletRequest, this);
                httpServletResponse.setContentType("text");
                httpServletResponse.setCharacterEncoding("UTF-8");
                httpServletResponse.getWriter().write(list);
                resultMessage = null;
    ...
    public String getPreSkillOverlay() {
        ...
        if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
            try {
                String list = ServiceLocator.getRequirementService().getPreSkillOverlay(httpServletRequest, this);
                httpServletResponse.setContentType("text");
                httpServletResponse.setCharacterEncoding("UTF-8");
                httpServletResponse.getWriter().write(list);
                resultMessage = null;
    ...
    public String doReleaseRequirements() {
        ...
        if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
            try {
                ...
                int record = ServiceLocator.getRequirementService().doReleaseRequirements(httpServletRequest, this);
                httpServletResponse.setContentType("text");
                httpServletResponse.setCharacterEncoding("UTF-8");
     ...
     * *************************************
     *
     * @getCustomerSkills() method is used to get Requirement details of account
     *
     ...
     **************************************
     */
    public String getConsultantSkillCSR() {
        resultMessage = LOGIN;
        if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
            try {
                setUserSessionId(Integer.parseInt(httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString()));
                String skillsCSR = ServiceLocator.getRequirementService().getConsultantSkillCSR(httpServletRequest, this);
                httpServletResponse.setContentType("text");
                httpServletResponse.setCharacterEncoding("UTF-8");
                httpServletResponse.getWriter().write(skillsCSR);
                resultMessage = null;
            } catch (Exception ex) {
                ex.printStackTrace();
                resultMessage = ERROR;
    ...
    public String getRequirementDashBoardDetails() {
        ...
        if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
            try {
                ...
                String csrReq = ServiceLocator.getRequirementService().getRequirementDashBoardDetails(httpServletRequest, this);
                httpServletResponse.setContentType("text");
                httpServletResponse.setCharacterEncoding("UTF-8");
    ...
    public String getRequirementDashBoardDetailsOnOverlay() {
        ...
        if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
            try {
                setUserSessionId(Integer.parseInt(httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString()));
                setTypeOfUser(httpServletRequest.getSession(false).getAttribute(ApplicationConstants.TYPE_OF_USER).toString());
                String csrReq = ServiceLocator.getRequirementService().getRequirementDashBoardDetailsOnOverlay(httpServletRequest, this);
                httpServletResponse.setContentType("text");
                httpServletResponse.setCharacterEncoding("UTF-8");
                httpServletResponse.getWriter().write(csrReq);
                resultMessage = null;
    ...
    public String getVendorRequirementDashBoardDetails() {
        ...
        if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
            try {
                setUserSessionId(Integer.parseInt(httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString()));
                String csrReq = ServiceLocator.getRequirementService().getVendorRequirementDashBoardDetails(httpServletRequest, this);
                httpServletResponse.setContentType("text");
                httpServletResponse.setCharacterEncoding("UTF-8");
                httpServletResponse.getWriter().write(csrReq);
                resultMessage = null;
    ...
    public String getVendorRequirementsDashBoard() {
        ...
        if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
            try {
                setUserSessionId(Integer.parseInt(httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString()));
                String csrReq = ServiceLocator.getRequirementService().getVendorRequirementsDashBoard(httpServletRequest, this);
                httpServletResponse.setContentType("text");
                httpServletResponse.setCharacterEncoding("UTF-8");
                httpServletResponse.getWriter().write(csrReq);
                resultMessage = null;
    ...
    public String getVendorDashBoardDetailsOnOverlay() {
        ...
        if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
            try {
                ...
                setUserSessionId(Integer.parseInt(httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString()));
                String csrReq = ServiceLocator.getRequirementService().getVendorDashBoardDetailsOnOverlay(httpServletRequest, this);
                httpServletResponse.setContentType("text");
                httpServletResponse.setCharacterEncoding("UTF-8");
                httpServletResponse.getWriter().write(csrReq);
                resultMessage = null;
    ...
    public String getCustomerRequirementDashBoardDetails() {
        ...
        if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
            try {
                setUserSessionId(Integer.parseInt(httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString()));
                setSessionOrgId(Integer.parseInt(httpServletRequest.getSession(false).getAttribute(ApplicationConstants.ORG_ID).toString()));
                String csrReq = ServiceLocator.getRequirementService().getCustomerRequirementDashBoardDetails(httpServletRequest, this);
                httpServletResponse.setContentType("text");
                httpServletResponse.setCharacterEncoding("UTF-8");
                httpServletResponse.getWriter().write(csrReq);
                resultMessage = null;
    ...
    public String getPreferedSkillDetails() {
        ...
        if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
            try {
                setUserSessionId(Integer.parseInt(httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString()));
                String skills = ServiceLocator.getRequirementService().getPreferedSkillDetails(httpServletRequest, this);
                skills = skills.replaceAll("<br/>", "\n");
                httpServletResponse.setContentType("text");
                httpServletResponse.setCharacterEncoding("UTF-8");
                httpServletResponse.getWriter().write(skills);
