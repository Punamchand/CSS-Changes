    ...
    public String getProjectBudgetSearchResults() {
        ...
        if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
            try {
                ...
                setSessionOrgId(Integer.parseInt(httpServletRequest.getSession(false).getAttribute(ApplicationConstants.ORG_ID).toString()));
                setRoleValue(httpServletRequest.getSession(false).getAttribute(ApplicationConstants.PRIMARYROLEVALUE).toString());
                String csrReq = ServiceLocator.getBudgetService().getProjectBudgetSearchResults(httpServletRequest, this);
        ...
        if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
            try {
                ...
                if (getFlag().equalsIgnoreCase("A") || getFlag().equalsIgnoreCase("R")) {
                    ...
                    csrReq = ServiceLocator.getBudgetService().setDirectorResultForBudget(httpServletRequest, this);
                } else {
                    csrReq = ServiceLocator.getBudgetService().saveProjectBudgetDetails(httpServletRequest, this);
                }
                httpServletResponse.setContentType("text");
                httpServletResponse.setCharacterEncoding("UTF-8");
                httpServletResponse.getWriter().write(csrReq);
    ...
    public String getProjectBudgetDetailsToViewOnOverlay() {
        ...
        if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
            try {
                setUserSessionId(Integer.parseInt(httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString()));
                setSessionOrgId(Integer.parseInt(httpServletRequest.getSession(false).getAttribute(ApplicationConstants.ORG_ID).toString()));
                String csrReq = ServiceLocator.getBudgetService().getProjectBudgetDetailsToViewOnOverlay(httpServletRequest, this);
                httpServletResponse.setContentType("text");
                httpServletResponse.setCharacterEncoding("UTF-8");
                httpServletResponse.getWriter().write(csrReq);
                resultMessage = null;
    ...
    public String doBudgetRecordDelete() {
        ...
        if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
            try {
                setUserSessionId(Integer.parseInt(httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString()));
                setSessionOrgId(Integer.parseInt(httpServletRequest.getSession(false).getAttribute(ApplicationConstants.ORG_ID).toString()));
                String csrReq = ServiceLocator.getBudgetService().doBudgetRecordDelete(httpServletRequest, this);
                httpServletResponse.setContentType("text");
                httpServletResponse.setCharacterEncoding("UTF-8");
                httpServletResponse.getWriter().write(csrReq);
                resultMessage = null;
