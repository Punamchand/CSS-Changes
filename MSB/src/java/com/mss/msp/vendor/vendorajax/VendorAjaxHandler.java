...
public class VendorAjaxHandler extends ActionSupport implements ServletRequestAware, ServletResponseAware {
    ...
    public String getVendorStates() {
        ...
        if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
            try {
                String states = ServiceLocator.getVendorAjaxHandlerService().getVendorStates(httpServletRequest, this);
    ...
    public String getVendorSearchDetails() {
        ...
        if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
            try {
                ...
                String list = ServiceLocator.getVendorAjaxHandlerService().getVendorSearchDetails(httpServletRequest, this);
                httpServletResponse.setContentType("text");
                httpServletResponse.setCharacterEncoding("UTF-8");
...
//            System.out.println("Ajax Handler action");
            if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
                ...
                int result = ServiceLocator.getVendorAjaxHandlerService().updateVendorDetails(httpServletRequest, this);
    ...
    public String getVendorsListByTireType() {
        ...
        try {
            ...
            if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
                ...
                stateList = ServiceLocator.getVendorAjaxHandlerService().getVendorsListByTireType(httpServletRequest, this);
//                System.out.println("===============>in ajax  handler action" + stateList);
                httpServletResponse.setContentType("text");
                httpServletResponse.setCharacterEncoding("UTF-8");
                httpServletResponse.getWriter().write(stateList);
    ...
    public String SaveVendorsAssociationDetals() {
        ...
        try {
            ...
            if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
                ...
                stateList = ServiceLocator.getVendorAjaxHandlerService().SaveVendorsAssociationDetals(httpServletRequest, this);
    ...
    public String getVendorAssociationDetails() {
        ...
        try {
            System.out.println("Ajax Handler action");
            if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
                stateList = ServiceLocator.getVendorAjaxHandlerService().getVendorAssociationDetails(httpServletRequest, this);
//                System.out.println("===============>in ajax  handler action" + stateList);
                httpServletResponse.setContentType("text");
                httpServletResponse.setCharacterEncoding("UTF-8");
                httpServletResponse.getWriter().write(stateList);
    ...
    public String searchVendorAssociationDetails() {
        ...
        try {
            ...
            if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
                ...
                stateList = ServiceLocator.getVendorAjaxHandlerService().searchVendorAssociationDetails(httpServletRequest, this);
                System.out.println("===============>in ajax  handler action" + stateList);
                httpServletResponse.setContentType("text");
                httpServletResponse.setCharacterEncoding("UTF-8");
                httpServletResponse.getWriter().write(stateList);
    ...
    public String editVendorAssociation() {
        ...
        try {
            ...
            if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
                System.out.println("===============>in ajax  handler action praven");
                setSessionOrgId(Integer.parseInt(httpServletRequest.getSession(false).getAttribute(ApplicationConstants.ORG_ID).toString()));
                vendorList = ServiceLocator.getVendorAjaxHandlerService().editVendorAssociation(httpServletRequest, getVendorId(),getSessionOrgId());
