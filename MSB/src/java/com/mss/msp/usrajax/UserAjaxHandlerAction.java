...
//        createPath=new File(createPath.getAbsolutePath()+"//MirageV2/+getRequestType()+"/+String.valueOf(date.getYear()+1900)+"/+monthName+"/+weekName);
    ...
    public String getAddressDetails() {
        ...
        try {
            ...
            if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
                searchAddressDetails = ServiceLocator.getUserAjaxHandlerService().getEmpAddressDetails(httpServletRequest, userid);
                httpServletResponse.setContentType("text");
                httpServletResponse.setCharacterEncoding("UTF-8");
    ...
    public String setAddressDetails() {
        ...
        try {
            ...
            if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
                int updateDetails = ServiceLocator.getUserAjaxHandlerService().setEmpAddressDetails(httpServletRequest, userid, address, address2, city, state, zip, country, phone, address_flag);
    ...
    public String setCAddressDetails() {
        ...
        try {
            ...
            if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
                int updateDetails = ServiceLocator.getUserAjaxHandlerService().setEmpCAddressDetails(httpServletRequest, userid, address, address2, city, state, zip, country, phone, address_flag);
...
//                System.out.println("" + editoverlay);
    ...
    public String getTaskTypeData() {
        ...
        try {
            ...
            if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
                ...
                taskString = ServiceLocator.getUserAjaxHandlerService().getTypesOfTask(httpServletRequest, this);
    ...
    public String getRelatedToNames() {
        ...
        try {
            ...
            if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
                setUserSessionId(Integer.parseInt(httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID).toString()));
                taskString = ServiceLocator.getUserAjaxHandlerService().getRelatedToNames(httpServletRequest, this);
    ...
    public String getAttachment() {
        ...
        try {
            //  System.out.println("Ajax Handler action");
            if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
                attachmentString = ServiceLocator.getUserAjaxHandlerService().getAttachment(httpServletRequest, this);
    ...
    public String doDeactiveAttachment() {
        ...
        try {
            ...
            if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
                ...
                attachmentString = ServiceLocator.getUserAjaxHandlerService().doDeactiveAttachment(httpServletRequest, this);
                System.out.println("===============>in Action----->" + attachmentString);
                httpServletResponse.setContentType("text");
                httpServletResponse.setCharacterEncoding("UTF-8");
                httpServletResponse.getWriter().write(attachmentString);
...
//    }
    public String addLeaveDetails() {
        ...
        try {
            ...
            if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
                ...
                List rep = dsdp.getReportsTo(Integer.parseInt(userId));
    ...
    public String getStatesOfCountry() {
        ...
        try {
            ...
            String stateList = ServiceLocator.getUserAjaxHandlerService().getStatesOfCountry(httpServletRequest, getCountryId());
            //setStateMap(states);
    ...
    public String LeavesListOfUser() {
        ...
        if (httpServletRequest.getSession(false).getAttribute(ApplicationConstants.USER_ID) != null) {
            ...
            try {
                ...
                String leavesListDetails = ServiceLocator.getUserAjaxHandlerService().getLeavesListDetails(httpServletRequest, this);
