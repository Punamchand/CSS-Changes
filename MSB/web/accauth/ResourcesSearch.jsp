                                ...
                                <div class="" id="profileBox" style="float: left; margin-top: 5px">
                                    ...
                                    <div class="col-sm-16">
                                        ...
                                        <s:form action="searchAccAuthorization" theme="simple">
                                            ...
                                            <div class="col-lg-4">
                                                <br>
                                                <a href='actionResourcesForAddOrUpdate.action?action_id=<s:property value="%{action_id}"/>&AMP;action_name=<s:property value="%{action_name}"/>&AMP;accType=C'<input type="button" class="cssbutton" value="Add ">Add</a>


                                                <input type="button"
                                                       class="cssbutton"
                                                       value="Search" onclick="return getActionResorucesSearchResults();"/>
                                            </div>
                                            <br>
                                        </s:form>
