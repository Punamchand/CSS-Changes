    ...
    <body style="overflow-x: hidden">
                                                    ...
                                                    <div class="col-lg-2">
                                                        <div class="row">
                                                            <div class="col-lg-11">
                                                                ...
                                                                <a href="#" ><input type="button" class="cssbutton_emps form-control" value="Search" style="margin:5px" onclick="getVendorDashboardList();"></a>
                                                            </div>
                                                        </div>
                                                    </div>   
                                                </div>
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <s:form>
                                            ...
                                            <script type="text/javascript">
                                                var dashPager = new Pager('dashboardResults', 10);
                                                dashPager.init();
        ...
        <script>
            ...
            for (var i = 0; i < montharr.length; i++){
                Combined[i + 1] = [ montharr[i], reqarr[i], selarr[i],rejarr[i] ];
            }
