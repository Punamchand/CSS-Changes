...
function Pager(tableName, itemsPerPage) {
    ...
    this.showPageNav = function(pagerName, positionId) {
        ...
        var pagerHtml = '<span onclick="' + pagerName + '.prev();" class="pg-normal" "> <font align="bottom" class="jumpbar"> Page: <img src="/MSB/includes/images/jumpbar_prev.gif" border="0" alt="l"> </span> ';
        ...
        pagerHtml += '<span onclick="'+pagerName+'.next();" class="pg-normal"> <img src="/MSB/includes/images/jumpbar_next.gif" border="0" ></span></font>';
