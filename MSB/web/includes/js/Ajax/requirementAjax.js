...
function RequirementValidations(){
   ...
   if(requirementDurationDescriptor=="-1")
    ...
    if(billingContact=="DF"){
     ...
     if(targetrate > requirementMaxRate)
    {
        alert("hello")
...
function updaterequirements(){
    ...
    if(RequirementValidations()){
        ...
        +jobdesc+'&RequirementPreferredSkills='+preferredSkills+'&RequirementYears='+Exp+'&billingContact='+billingContact+'&requirementDurationDescriptor='+requirementDurationDescriptor+'&requirementMaxRate='+requirementMaxRate;
        //  alert(url)
        var req=initRequest(url);
        req.onreadystatechange = function() {
