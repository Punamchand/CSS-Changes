...
<html>
    <head>
        ...
        <title>Miracle Service Bay ::Team Task Search</title>
                        ...
                        <div class="features_items">
                            <div class="col-lg-14 ">
                                <div class="" id="profileBox" style="float: left; margin-top: 5px">
                                    ...
                                    <!-- content start -->
                                    <div class="col-sm-12">
                                        <s:form action="showTeamTaskSearchDetails" theme="simple">
                                            <%--<br>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6">
                                                                <label class="labelStylereq" style=""></label>
                                                                <a href="../tasks/addTask.action" ><input type="button" class="cssbutton_emps form-control " value="Add" style="margin:5px"/></a> 
                                                            </div>
                                                        </div>
                                                    </div>
