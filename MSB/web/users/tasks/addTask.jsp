                        ...
                        <div class="features_items">
                            <div class="col-lg-14 ">
                                <div class="" id="profileBox" style="float: left; margin-top: 5px">
                                    ...
                                    <s:form action="addNewTask"  theme="simple"   enctype="multipart/form-data" >
                                        <span><editTask></editTask></span>
                                        <div class="inner-reqdiv-elements">
                                            <div class="row">
                                                <div class="col-lg-4 required">
                                                    <label class="labelStylereq" style="color: #56a5ec;">StartDate: </label>
                                                    <s:textfield cssClass="form-control dateImage" name="startDate" id="startDate" placeholder="StartDate" value="%{startDate}" cssStyle="z-index: 10000004;"/>
                                                </div>
                                                <div class="col-lg-4 required">
                                                    <label class="labelStylereq" style="color: #56a5ec;">EndDate: </label>
                                                    <s:textfield cssClass="form-control dateImage"  name="endDate" value="%{endDate}" id="endDate" placeholder="EndDate" />
                                                </div>
                                                <div class="col-lg-4">
                                        ...
                                        <div>
                                            ...
                                            <div class="inner-reqdiv-elements-elements required">
                                                <label class="labelStylereq">Title</label>:<s:textfield name="taskName" id="task_name" placeholder="Enter Title Here" cssClass="titleStyle"  />
                                            </div>
                                            <div class="inner-reqdiv-elements">
                                                <label class="labelStylereq">Description</label>:<s:textarea name="task_comments" id="task_comments" placeholder="Enter Task Description Here" cssClass="areacss" onkeyup="checkCharacters(this)"/>
                                            </div>
                                            <div class="inner-reqdiv-elements">
                                                <div class="row">
                                                    <div class="col-lg-4">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <s:textfield  id="secondaryReport"  name="secondaryAssign" placeholder="SecondaryAssignTo" cssClass="form-control"  theme="simple" onkeyup="getSecondaryAssignedNames();" autocomplete='off'/>
                                                    </div>
                                                </div>
                                            </div>
                                            <%--div class="inner-addtaskdiv-elements">
                                            ...
                                            <div  class="inner-addtaskbtndiv-elements">
                                                ...
                                                <s:submit cssClass="cssbutton" value="AddTask" theme="simple" onclick="return addTaskValidation()"/>
                                            </div>
