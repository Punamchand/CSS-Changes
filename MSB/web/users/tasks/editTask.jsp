...
<html>
    <head>
        ...
        <title>Miracle Service Bay :: Tasks Page</title>
    ...
    <body onload="doOnLoad(); init();  " style="overflow-x: hidden">
                                        ...
                                        <div class="panel-body" id="panel-task-body" >
                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane fade in active" id="home">
                                                    ...
                                                    <form  theme="simple">
                                                        <div><br>
                                                            <span><editTask></editTask></span>
                                                            <div class="inner-reqdiv-elements">
                                                                <div class="row">
                                                                    <div class="col-lg-4 required">
                                                                        <label class="labelStylereq" style="color: #56a5ec;">StartDate: </label>
                                                                        <s:textfield cssClass="form-control dateImage" name="startDate" id="start_date"  value="%{tasksVto.start_date}" tabindex="1"  onkeypress="return enterDateRepository();"/>
                                                                        <s:hidden name="taskid" value="%{taskid}" id="taskid"/>
                                                                    </div>
                                                                    <div class="col-lg-4 required">
                                                                        <label class="labelStylereq" style="color: #56a5ec;">EndDate: </label>
                                                                        <s:textfield cssClass="form-control dateImage" name="endDate" id="end_date"  value="%{tasksVto.end_date}" tabindex="1"  onkeypress="return enterDateRepository();"/>
                                                                    </div>
                                                                    <div class="col-lg-4 ">
                                                            ...
                                                            <div class="inner-reqdiv-elements required">
                                                                ...
                                                                <s:textfield name="taskName" id="task-textform" placeholder="Enter Title Here" cssClass="form-control" value="%{tasksVto.task_title}"  />
                                                            </div>
                                                            <div class="inner-reqdiv-elements">
                                                                <label class="labelStylereq" style="color: #56a5ec;">Description:</label>
                                                                <s:textarea name="task_comments" id="task_comments" placeholder="Enter Task Description Here" cssClass="form-control" onkeyup="checkCharacters(this)" value="%{tasksVto.task_comments}"/>
                                                            </div>
                                                            <div class="inner-reqdiv-elements">
                                                                <div class="row">
                                                                    <div class="col-lg-4">
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        ...
                                                                        <s:textfield  id="secondaryReport"  name="sec_assign_to" placeholder="SecondaryAssignTo" cssClass="form-control"  theme="simple" onkeyup="return getSecondaryAssignedNames();" value="%{tasksVto.sec_assigned_to}" autocomplete='off'/>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div  class="inner-addtaskbtndiv-elements">
                                                                <s:submit cssClass="cssbutton" value="save" theme="simple"  onclick="return doUpdateTaskInfo();"/>
                                                            </div>
                                                        </div>
                                                    </form>
                                                </div>
                                                                                    ...
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div>
                                                                                            <div class="col-lg-4 required">
                                                                                                ...
                                                                                                <s:textfield cssClass="form-control"  name="notes" id="notes_NameSearch" placeholder="Notes" onclick="clearResultMsg()"/>
                                                                                            </div>  
                                                                                            <div class="col-lg-4 required">
                                                                                                <label class="labelStylereq " style="color:#56a5ec;">Notes Id:</label>
                                                                                                <s:textfield cssClass="form-control " id="notes_id" name="notes_id"  placeholder="Notes_Id" onclick="clearResultMsg()"/>
                                                                                            </div> 
                                                                                            <div class="col-lg-4">
                                                                                                <div class="row">
                                                                                                    <div class="col-lg-6">
                                                                                                        <label class="labelStylereq" style="color:#56a5ec;"></label>
                                                                                                        <s:submit cssClass="cssbutton_emps form-control " id="searchButton" value="search" onclick="clearResultMsg();return getNotesDetailsBySearch()" cssStyle="margin:5px"/>
                                                                                                    </div>
                                                                                                    <div class="col-lg-6">
                                                                                                        <label class="labelStylereq" style="color:#56a5ec;"></label>
                                                                                                        <a href="" class="Note_popup_open" ><input type="button" class="cssbutton_emps form-control " value="Add notes" style="margin:5px"></a>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>         
                                                                        ...
                                                                        <s:form action=""  theme="simple"   enctype="multipart/form-data" >
                                                                            <div>
                                                                                ...
                                                                                <div class="inner-addtaskdiv-elements required">
                                                                                    ...
                                                                                    <s:textfield name="noteNames"  id="noteNamesadd" cssClass="form-control"/>
                                                                                ...
                                                                                <div  class="inner-addtaskbtndiv-elements">
                                                                                    ...
                                                                                    <%--<s:submit cssClass="cssbutton task_popup_close" value="AddTask" theme="simple" onclick="addTaskFunction();" />--%>
                                                                                    <s:submit cssClass="cssbutton" value="AddNote" theme="simple" onclick="return addNotesDetails()"/>
                                                                                </div>
                                                                            ...
                                                                            <div>
                                                                                ...
                                                                                <form>
                                                                                    <div class="inner-addtaskdiv-elements required">
                                                                                        ...
                                                                                        <s:textfield name="noteNames"  id="noteNames" cssClass="form-control"/>
                                                                                        <label style="color:#56a5ec;" class="task-label">Description:</label>
                                                                                    ...
                                                                                    <div  class="inner-addtaskbtndiv-elements">
                                                                                        <s:reset cssClass="cssbutton " value="Clear" theme="simple" />
                                                                                        <%--<s:submit cssClass="cssbutton task_popup_close" value="AddTask" theme="simple" onclick="addTaskFunction();" />--%>
                                                                                        <s:submit cssClass="cssbutton" value="AddNote" theme="simple" onclick="return updateNoteDetails()"/>
                                                                                    </div>
                                                                                </form>
                                                                            </div>           
                                                                        </div>
