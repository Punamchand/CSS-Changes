...
<html>
    <head>
        ...
        <title>Miracle Service Bay :: Leave Search Page</title>
                                    ...
                                    <div class="col-lg-14"><br>
                                        <s:form action="showTeamMemberSearchDetails" theme="simple">
                                            ...
                                            <ul class="nav nav-pills">
                                                ...
                                                <div class="leavefield-margin">
                                                    <s:submit cssClass="col-lg-offset-9 cssbutton " id="searchButton" value="search"  onclick="return leaveSearchDateValidation()"/>
                                                </div>
                                            </ul>
                                        </s:form>
                                    </div>
