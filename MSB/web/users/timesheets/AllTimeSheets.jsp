...
<html>
    <head>
        ...
        <title>Miracle Service Bay :: Team Time sheets Search</title>
                        ...
                        <div class="features_items">
                            <div class="col-lg-14 ">
                                <div class="" id="profileBox" style="float: left; margin-top: 5px">
                                    ...
                                    <div class="col-sm-13">
                                                              <s:form action="getAllTimeSheetsSearch" theme="simple" >
                                            <br>
                                            <ul class="nav nav-pills">
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <s:textfield cssClass="form-control" name="startDate" id="docdatepickerfrom" placeholder="FromDate" value="%{startDate}" tabindex="1"  onkeypress="return enterDateRepository();"/>
                                                </div>
                                                <div class="col-lg-4">
                                                    <label class="labelStylereq" style="color:#56a5ec;">To Date:</label>
                                                    <s:textfield cssClass="form-control" name="endDate" placeholder="ToDate" value="%{endDate}" id="docdatepicker" tabindex="2"  onkeypress="return enterDateRepository();"/>
                                                </div>
                                                <div class="col-lg-4">
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <s:textfield id="tmmember" name="tmmember" cssClass="form-control" placeholder="Name"/>
                                                </div>
                                                <div class="col-lg-4">
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <s:textfield id="vendorName" name="vendorName" cssClass="form-control" placeholder="Name"/>
                                                </div>
                                                    </s:if>
                                                    <s:else>
                                                       <div class="col-lg-4">
                                                    <label class="labelStylereq" style="color:#56a5ec;">Customer Name:</label>
                                                    <s:textfield id="customerName" name="customerName" cssClass="form-control" placeholder="Name"/>
                                                </div> 
                                                    </s:else>    
                                                ...
                                                <div class="col-lg-4">
                                                    ...
                                                    <s:submit cssClass="cssbuttonTimesheet" id="searchButton" value="search" />
                                                </div>
                                            </ul>
                                            <br>
                                        </s:form>
